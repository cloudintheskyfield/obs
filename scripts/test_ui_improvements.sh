...
test_file_exists "src/omni_agent/main.py" "后端主文件存在"
echo ""
...
echo "📋 测试 6: 检查服务启动优化"
echo "--------------------------------"
test_file_contains "src/omni_agent/main.py" "本地访问" "main.py 包含启动信息输出"
test_file_contains "src/omni_agent/main.py" "actual_port" "main.py 包含端口变量"
echo ""
...
if [ $FAILED -eq 0 ]; then
    ...
    echo ""
    echo "🚀 下一步："
    echo "   1. 启动服务: python -m omni_agent.main serve --reload"
