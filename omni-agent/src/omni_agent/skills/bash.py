...
class BashSkill(BaseSkill):
    ...
    def __init__(self, work_dir: str = "workspace"):
        ...
        # 定义参数
        self.add_parameter("command", "str", "Bash command to execute", True)
        self.add_parameter("timeout", "int", "Command timeout in seconds", False, 30)
        self.add_parameter("background", "bool", "Run command in background", False, False)
