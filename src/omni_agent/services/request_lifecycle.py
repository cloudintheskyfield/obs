        ...
        return {
            ...
            "flow": [
                ...
                },
                {
                    ...
                    "role_zh": "按 agent / create / plan / review / battle 分发请求，保持 UI、API 与执行环的边界清晰。",
                    "role_en": "Dispatches the request across agent / create / plan / review / battle lanes so UI, API, and execution loops stay cleanly separated.",
            ...
            "mode_routes": [
                ...
                {"mode": "create", "handler": "_native_tool_stream() + create harness", "purpose_zh": "把一句话产品想法扩展为可运行前后端应用", "purpose_en": "Turns a one-line product idea into a runnable full-stack application scaffold"},
